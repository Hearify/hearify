...
from ml_service.app.models.question import Question
from ml_service.app.modules.text_cleaning import clean_text
from ml_service.app.ml_models.question_generation.question_generator import QuestionGenerator
from ml_service.app.ml_models.distractor_generation.distractor_generator import DistractorGenerator
from ml_service.app.ml_models.sense2vec_distractor_generation.sense2vec_generation import Sense2VecDistractorGeneration
from ml_service.app.modules.duplicate_removal import remove_distractors_duplicate_with_correct_answer, remove_duplicates
...
class MCQGenerator:
    def __init__(self, is_verbose=False):
        start_time = time.perf_counter() if is_verbose else ''
    ...
    # Main function
    def generate_mcq_questions(self, context: str, desired_count: int, verbose: bool = False) -> list[Question]:
